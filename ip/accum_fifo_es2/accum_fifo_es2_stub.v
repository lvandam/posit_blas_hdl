...
module accum_fifo_es2(wr_clk, rd_clk, din, wr_en, rd_en, dout, full, wr_ack, 
  overflow, empty, valid, underflow)
/* synthesis syn_black_box black_box_pad_pin="wr_clk,rd_clk,din[67:0],wr_en,rd_en,dout[67:0],full,wr_ack,overflow,empty,valid,underflow" */;
  input wr_clk;
  input rd_clk;
  input [67:0]din;
  input wr_en;
